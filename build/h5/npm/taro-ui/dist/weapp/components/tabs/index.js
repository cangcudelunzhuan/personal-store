(my["webpackJsonp"] = my["webpackJsonp"] || []).push([["npm/taro-ui/dist/weapp/components/tabs/index"],{
...
var ENV = _taroAlipay2.default.getEnv();
...
var AtTabs = (_temp2 = _class = function (_AtComponent) {
  ...
  function AtTabs() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AtTabs.__proto__ || Object.getPrototypeOf(AtTabs)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "anonymousState__temp2", "anonymousState__temp3", "anonymousState__temp4", "loopArray58", "tabList", "rootCls", "scroll", "_tabId", "scrollX", "scrollY", "_scrollLeft", "_scrollTop", "_scrollIntoView", "swipeable", "tabDirection", "current", "customStyle", "className", "height", "animated", "children"], _this.updateState = function (idx) {
      if (_this.props.scroll) {
        // 标签栏滚动
        switch (ENV) {
          case _taroAlipay2.default.ENV_TYPE.WEAPP:
          case _taroAlipay2.default.ENV_TYPE.ALIPAY:
          case _taroAlipay2.default.ENV_TYPE.SWAN:
            {
          ...
          case _taroAlipay2.default.ENV_TYPE.WEB:
            {
  ...
  _createClass(AtTabs, [{
    ...
    value: function getTabHeaderRef() {
      if (ENV === _taroAlipay2.default.ENV_TYPE.WEB) {
    ...
    value: function _createData() {
      ...
      var anonymousState__temp = (0, _taroAlipay.internal_inline_style)(this.mergeStyle(heightStyle, customStyle));
      var anonymousState__temp2 = scroll ? (0, _taroAlipay.internal_inline_style)(heightStyle) : null;
      var anonymousState__temp3 = (0, _taroAlipay.internal_inline_style)(this.mergeStyle(bodyStyle, heightStyle));
      var anonymousState__temp4 = (0, _taroAlipay.internal_inline_style)(underlineStyle);
      var loopArray58 = tabList.map(function (item, idx) {
        item = {
...
Component(__webpack_require__(/*! @tarojs/taro-alipay */ "./node_modules/@tarojs/taro-alipay/index.js").default.createComponent(AtTabs));
...
module.exports = __webpack_require__.p + "npm/taro-ui/dist/weapp/components/tabs/index.axml";
