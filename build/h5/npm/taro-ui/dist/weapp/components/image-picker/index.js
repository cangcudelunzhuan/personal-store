(my["webpackJsonp"] = my["webpackJsonp"] || []).push([["npm/taro-ui/dist/weapp/components/image-picker/index"],{
...
var AtImagePicker = (_temp2 = _class = function (_AtComponent) {
  ...
  function AtImagePicker() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AtImagePicker.__proto__ || Object.getPrototypeOf(AtImagePicker)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "loopArray60", "rootCls", "matrix", "mode", "className", "customStyle", "files", "length", "showAddBtn", "multiple", "count", "sizeType", "sourceType", "onFail"], _this.chooseFile = function () {
      ...
      var filePathName = ENV === _taroAlipay2.default.ENV_TYPE.ALIPAY ? 'apFilePaths' : 'tempFiles';
      ...
      _taroAlipay2.default.chooseImage(params).then(function (res) {
  ...
  _createClass(AtImagePicker, [{
    ...
    value: function _createData() {
      ...
      var anonymousState__temp = (0, _taroAlipay.internal_inline_style)(customStyle);
      var loopArray60 = matrix.map(function (row, i) {
        row = {
          $original: (0, _taroAlipay.internal_get_original)(row)
        };
        var $loopState__temp3 = i + 1;
        var $anonymousCallee__9 = row.$original.map(function (item, j) {
          item = {
...
Component(__webpack_require__(/*! @tarojs/taro-alipay */ "./node_modules/@tarojs/taro-alipay/index.js").default.createComponent(AtImagePicker));
...
module.exports = __webpack_require__.p + "npm/taro-ui/dist/weapp/components/image-picker/index.axml";
