(my["webpackJsonp"] = my["webpackJsonp"] || []).push([["npm/taro-ui/dist/weapp/components/noticebar/index"],{
  ...
  _createClass(AtNoticebar, [{
    ...
    value: function _constructor(props) {
      ...
      this.state = {
        ...
        animationData: [{}],
        dura: 15,
        isWEAPP: _taroAlipay2.default.getEnv() === _taroAlipay2.default.ENV_TYPE.WEAPP,
        isALIPAY: _taroAlipay2.default.getEnv() === _taroAlipay2.default.ENV_TYPE.ALIPAY,
        isWEB: _taroAlipay2.default.getEnv() === _taroAlipay2.default.ENV_TYPE.WEB
      };
    ...
    value: function initAnimation() {
      ...
      this.timeout = setTimeout(function () {
        ...
        if (_this2.state.isWEB) {
          ...
          var query = isALIPAY ? _taroAlipay2.default.createSelectorQuery() : _taroAlipay2.default.createSelectorQuery().in(_this2.$scope);
          query.select("." + _this2.state.animElemId).boundingClientRect().exec(function (res) {
            ...
            var dura = width / +_this2.props.speed;
            var animation = _taroAlipay2.default.createAnimation({
              duration: dura * 1000,
              timingFunction: 'linear'
            });
            var resetAnimation = _taroAlipay2.default.createAnimation({
              duration: 0,
              timingFunction: 'linear'
            });
            var resetOpacityAnimation = _taroAlipay2.default.createAnimation({
              duration: 0,
              timingFunction: 'linear'
            });
    ...
    value: function _createData() {
      ...
      var anonymousState__temp2 = this.__state.show ? (0, _taroAlipay.internal_inline_style)(customStyle) : null;
      ...
      var anonymousState__temp6 = this.__state.show ? (0, _taroAlipay.internal_inline_style)(style) : null;
...
Component(__webpack_require__(/*! @tarojs/taro-alipay */ "./node_modules/@tarojs/taro-alipay/index.js").default.createComponent(AtNoticebar));
...
module.exports = __webpack_require__.p + "npm/taro-ui/dist/weapp/components/noticebar/index.axml";
