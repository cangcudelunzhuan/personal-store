...
class ListView extends Taro.Component {
  ...
  render() {
    const { style, hasMore, noMore, isEmpty, emptyText, className, isError, isLoaded, selector, launch = {}, footerLoadingText, footerLoadedText, damping, circleColor } = this.props;
