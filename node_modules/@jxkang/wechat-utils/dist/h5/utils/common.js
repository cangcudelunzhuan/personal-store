...
const extend = function () {
  ...
  const isPlainObject = function (obj) {
    let proto;let Ctor;if (!obj || toString.call(obj) !== '[object Object]') {
      return false;
    }proto = getProto(obj);if (!proto) {
      return true;
    }Ctor = hasOwn.call(proto, 'constructor') && proto.constructor;return typeof Ctor === 'function' && fnToString.call(Ctor) === ObjectFunctionString;
  };
  let a;let b;let c;let d;let e;let f;let g = arguments[0] || {};let h = 1;const i = arguments.length;let j = false;for (typeof g == 'boolean' && (j = g, g = arguments[h] || {}, h++), typeof g == 'object' || isFunction(g) || (g = {}), h === i && (g = this, h--); h < i; h++) if ((a = arguments[h]) != null) for (b in a) c = g[b], d = a[b], g !== d && (j && d && (isPlainObject(d) || (e = Array.isArray(d))) ? (e ? (e = false, f = c && Array.isArray(c) ? c : []) : f = c && isPlainObject(c) ? c : {}, g[b] = extend(j, f, d)) : undefined !== d && (g[b] = d));return g;
};
const noop = () => {};

class Common {
  isType = (d, t) => {
    return t && typeof t === 'string' ? class2type.toString.call(d) === `[object ${t.replace(/^(\w)/, a => {
