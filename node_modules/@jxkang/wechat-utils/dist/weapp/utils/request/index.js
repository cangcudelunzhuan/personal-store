...
const request = function({
  ...
  headers = Object.assign(
    ...
    method==='POST'||method==='PUT'||method==='PATCH'?{ 'Content-Type': 'application/json; charset=UTF-8' }:{},
  ...
  return Taro.request(requestOptions).then(resData => {
...
$ajax.setBaseUrl = function(ajaxBaseUrl){
  const cacheBaseUrl = Taro.getStorageSync('ajaxBaseUrl')
