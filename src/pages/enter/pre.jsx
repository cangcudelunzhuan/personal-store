...
class Storeinfo extends Taro.Component {
  ...
  render() {
    return (
      <View className={styles.xiey}>
        ...
        <View>
        《康小铺平台合作协议》（以下简称“本协议”）是由康小铺平台（包括但不限于康小铺APP、微信公众号、微信商城及小程序等）的运营方即杭州康小铺网络科技有限公司（以下简称“甲方”）与以独立第三方经营者身份入驻康小铺平台的法律实体（以下简称“乙方”或“商家”）达成的关于提供和使用康小铺平台服务的各项条款。
  </View>
        <View>
  ...
  <View>
          4.1.合同与发货。买家支付价款，则商家与买家之间的买卖合同成立；订单确认（时，商家与买家之间的买卖合同生效。 商家应按对消费者的承诺及平台规则（包括但不限于《康小铺发货规则》、《康小铺特殊商品发货规则》等）及时将商品交付消费者。
  </View>
        <View>
  ...
  <View>
          6.2.3.监督检查。甲方有权对商家售后服务及客户服务的质量进行监督检查，根据平台规则（包括但不限于《康小铺售后规则》、《康小铺商家客户服务管理规则》）对商家进行考核，并对售后服务不达标、客服回复率或者回复态度不符合要求的商家进行处理。
  </View>
  <View>
          7.保证金及货款结算
  </View>
